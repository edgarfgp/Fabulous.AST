...
module Oak =
    ...
    let WidgetKey =
        Widgets.register "Oak" (fun widget ->
            let moduleOrNamespaces =
                Helpers.getNodesFromWidgetCollection<ModuleOrNamespaceNode> widget ModuleOrNamespaces
...
module OakBuilders =
    type Fabulous.AST.Ast with
        ...
        static member inline Oak() =
            CollectionBuilder<Oak, ModuleOrNamespaceNode>(Oak.WidgetKey, Oak.ModuleOrNamespaces)
