...
module IfThenElseBuilders =
    type Ast with
        ...
        static member IfThenElseExpr(ifExpr: WidgetBuilder<Expr>, thenExpr: WidgetBuilder<Expr>, elseExpr: string) =
            Ast.IfThenElseExpr(ifExpr, thenExpr, Ast.ConstantExpr(elseExpr))

        static member IfThenElseExpr(ifExpr: WidgetBuilder<Expr>, thenExpr: string, elseExpr: WidgetBuilder<Expr>) =
            Ast.IfThenElseExpr(ifExpr, Ast.ConstantExpr(thenExpr), elseExpr)

        static member IfThenElseExpr(ifExpr: WidgetBuilder<Expr>, thenExpr: string, elseExpr: string) =
        ...
        static member IfThenElseExpr(ifExpr: WidgetBuilder<Expr>, thenExpr: WidgetBuilder<Constant>, elseExpr: string) =
            Ast.IfThenElseExpr(ifExpr, thenExpr, Ast.Constant(elseExpr))

        static member IfThenElseExpr(ifExpr: WidgetBuilder<Expr>, thenExpr: string, elseExpr: WidgetBuilder<Constant>) =
        ...
        static member IfThenElseExpr(ifExpr: string, thenExpr: WidgetBuilder<Expr>, elseExpr: WidgetBuilder<Expr>) =
        ...
        static member IfThenElseExpr(ifExpr: string, thenExpr: string, elseExpr: WidgetBuilder<Expr>) =
            Ast.IfThenElseExpr(Ast.Constant(ifExpr), Ast.Constant(thenExpr), elseExpr)

        static member IfThenElseExpr(ifExpr: string, thenExpr: WidgetBuilder<Constant>, elseExpr: WidgetBuilder<Expr>) =
            Ast.IfThenElseExpr(Ast.Constant(ifExpr), thenExpr, elseExpr)
        ...
        static member IfThenElseExpr(ifExpr: string, thenExpr: string, elseExpr: WidgetBuilder<Constant>) =
            Ast.IfThenElseExpr(Ast.Constant(ifExpr), Ast.Constant(thenExpr), elseExpr)

        static member IfThenElseExpr(ifExpr: string, thenExpr: string, elseExpr: string) =
