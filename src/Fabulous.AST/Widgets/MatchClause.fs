...
module MatchClause =
    ...
    let WidgetKey = Widgets.register "MatchClause" (fun widget ->
        ...
        MatchClauseNode(
            ...
            Pattern.Named(PatNamedNode(
                None,
                SingleTextNode(patternNamed, Range.Zero),
                Range.Zero
            )),
            whenExpr,
...
module MatchClauseBuilders =
    type Fabulous.AST.Ast with
        static member inline MatchClause(patternNamed: string, whenExpr: WidgetBuilder<Expr>, bodyExpr: WidgetBuilder<Expr>) =
